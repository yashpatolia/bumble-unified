...
INSERT INTO dyes (dye_id, dye_name, weight, hex) VALUES
    ...
    ('brick_red_dye', 'Brick Red Dye', 1.0e-05, 'CB4154'),
    ('flame_dye', 'Flame Dye', 1.0e-05, 'E25822'),
    ('copper_dye', 'Copper Dye', 0.001, 'B87333'),
    ('fossil_dye', 'Fossil Dye', 0.0002, '866F12'),
    ('mango_dye', 'Mango Dye', 1.0e-05, 'FDBE02'),
    ('nyanza_dye', 'Nyanza Dye', 0.0004, 'E9FFDB'),
    ('emerald_dye', 'Emerald Dye', 2.0e-05, '50C878'),
    ('jade_dye', 'Jade Dye', 0.0002, '00A86B'),
    ('matcha_dye', 'Matcha Dye', 1.0e-05, '74A12E'),
    ('holly_dye', 'Holly Dye', 0.0125, '3C6746'),
    ('celeste_dye', 'Celeste Dye', 1.0e-05, 'B2FFFF'),
    ('frostbitten_dye', 'Frostbitten Dye', 0.0004, '09D8EB'),
    ('iceberg_dye', 'Iceberg Dye', 0.0001, '71A6D2'),
    ('tentacle_dye', 'Tentacle Dye', 0.001, '324D6C'),
    ('pearlescent_dye', 'Pearlescent Dye', 1.0e-05, '115555'),
    ('midnight_dye', 'Midnight Dye', 0.0001, '50216C'),
    ('dark_purple_dye', 'Dark Purple Dye', 0.25, '301934'),
    ('byzantium_dye', 'Byzantium Dye', 1.0e-05, '702963'),
    ('wild_strawberry_dye', 'Wild Strawberry Dye', 6.67e-07, 'FF43A4'),
    ('cyclamen_dye', 'Cyclamen Dye', 1.0e-05, 'F56FA1'),
    ('nadeshiko_dye', 'Nadeshiko Dye', 0.0013, 'F6ADC6'),
    ('pelt_dye', 'Pelt Dye', 0.0004, '50414C'),
    ('secret_dye', 'Secret Dye', 0.0001, '7D7D7D'),
    ('periwinkle_dye', 'Periwinkle Dye', 0.0002, 'CCCCFF'),
    ('bone_dye', 'Bone Dye', 3.33e-05, 'E3DAC9'),
    ('livid_dye', 'Livid Dye', 0.02, 'CEB7AA'),
    ('mocha_dye', 'Mocha Dye', 1.0e-06, '967969'),
